...
function Player() {
  ...
  <use xlinkHref="#More"></use>
          ...
          <div className="player__desc">
            <img className="player__desc-img" src={MargaretB} alt="" width="80" height="80"/>
            <div className="player__desc-textbox">
              ...
              <p className="player__desc-text">A successful marketing plan relies heavily on the pulling-power of advertising copy. Writing result-oriented ad copy is difficult, as it must appeal to, entice, and convince consumers to take action. There is no magic formula to write perfect ad copy; it is based on a number of factors, including ad placement, demographic, even the consumer’s mood when they see your ad.
              </p>
