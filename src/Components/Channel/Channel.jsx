  ...
  <use xlinkHref="#bell-logo"></use>
        ...
        <div className="channel__nav">
          ...
          <NavLink className="channel__nav-link" to="/">
            About</NavLink>
          <NavLink className="channel__nav-link" to="/">
 <svg className="icon channel__nav-search"> <use xlinkHref="#search"></use>
</svg>
          </NavLink>
        </div>
        <div className="channel__choose">
           ...
           <h3 className="channel__choose-title">Choosing The Best Audio Player Software For Your Computer</h3>
                <p className="channel__choose-text">Your cheap internet-based banner advertising will become one of the sought for ads there are. Today, the world of Internet advertising is rapidly evolving beyond banner ads and intrusive pop-ups. Bayles A common medium for advertising on the Internet is the use of banner ads. </p>
            ...
            <div className="channel__choose-rec">
                ...
                {UserData.map((user)=>{
                  return(
                <div className="channel__choose-users">
                <img className="channel__choose-recimg" src={user.img} alt="" width="50" height="50"/>
        ...
        <div className="channel__item">
            ...
            <ul className="channel__sublist">
              ...
              <img className="home__posts-img" src={BriefDesk} alt="" width="250px" height="150"/>
                <h4 className="channel__posts-title">A Brief History Of Creation</h4>
                <span className="channel__posts-view">80k views  ·  3 days ago</span>
